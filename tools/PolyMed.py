...
class PolyMed:
    ...
    def __init__(
        ...
        self.data_variable.save_data_stat(
            self.org_case_data, save_type="case", display=display, plotting=plotting
        )
        self.data_variable.save_data_stat(
            self.org_kb_data, save_type="knowledge", display=display, plotting=plotting
        )
    ...
    def data_integrity_test(self):
        ...
        for f_k in self.org_case_data.keys():
            ...
            print(
                ...
                Data_integrity.completeness_test(self.org_case_data[f_k]),
            )
            print(
                "Consistency test passed: ",
                Data_integrity.consistency_test(self.org_case_data[f_k]),
            )
            print(
                "Duplication test passed: ",
                Data_integrity.duplication_test(self.org_case_data[f_k]),
            )
            print(
                "Data format test passed: ",
                Data_integrity.data_format_test(self.org_case_data[f_k]),
            )
            print("-" * len(greeting))
        ...
        print(
            "Completeness test passed: ",
            Data_integrity.kb_completeness_test(self.org_kb_data),
        )
        print(
            "Consistency test passed: ",
            Data_integrity.kb_consistency_test(self.org_kb_data),
        )
        print(
            "Duplication test passed: ",
            Data_integrity.kb_duplication_test(self.org_kb_data),
        )
        print(
            "Data format test passed: ",
            Data_integrity.kb_data_format_test(self.org_kb_data),
        )
        print("-" * len(greeting))
        print("=" * len(greeting))
